...
export default function CreateEventPage() {
  ...
  const onSubmit = async (data: EventFormData) => {
    ...
    if (error) {
      ...
      router.push(`/organizer/${authUser.id}`); // Redirect to organizer's profile page
    }
  };
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-headline">Location</FormLabel>
                    <FormControl><Input placeholder="e.g., City Park Amphitheater or Online" {...field} className="font-body" /></FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              />
